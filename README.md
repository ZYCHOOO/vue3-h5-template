...
基于 Vue3 + Vue-Cli4 + Vant-ui + sass + axios 封装的移动端模版
...
### <span id="eruda">⚙️ eruda 移动端调试</span>

在开发环境和测试环境中显示 eruda 调试工具
...
若要在其他自定义环境中显示 eruda 调试工具，在`enums.js`的`DEBUG_WHITE_LIST`白名单中修改配置即可
...
vue3-h5-template 所有全局样式都在`@/styles`目录下设置
