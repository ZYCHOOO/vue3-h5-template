...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'Custom',
        component: () =>
          import(/* webpackChunkName: 'home-custom' */ '@/views/home/Custom'),
      ...
      },
      {
        ...
        name: 'Mine',
        component: () =>
          import(/* webpackChunkName: 'home-mine' */ '@/views/home/Mine'),
  ...
  },
  {
    ...
    name: 'VirtualList',
    component: () =>
      import(/* webpackChunkName: 'virtualList' */ '@/views/virtualList'),
    meta: { title: '虚拟长列表' }
  },
  ...demoRoutes
]
